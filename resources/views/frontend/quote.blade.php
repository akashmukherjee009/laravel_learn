            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="bg-light text-center p-5 wow fadeIn" data-wow-delay="0.5s">
                        <form method="post" action="{{url('/templete/quote')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="phno" class="form-control border-0" placeholder="Your Mobile" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="file" name="img" class="form-control border-0" placeholder="Your Mobile" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <select class="form-select border-0" style="height: 55px;" name="freight">
